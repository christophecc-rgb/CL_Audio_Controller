...
class MidiNetworkToolsTests(unittest.TestCase):
    ...
    def test_dashboard_is_a_network_only_technical_panel(self):
        ...
        self.assertIn('toggleNetworkSession:', source)
        self.assertIn('changeConnectionPolicy:', source)
        self.assertIn('session.networkPort', source)
        ...
        self.assertIn('MIDINetworkSession.defaultSession.enabled = YES', source)
