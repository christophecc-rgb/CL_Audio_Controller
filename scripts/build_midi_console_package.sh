...
for tool in CLMIDINetworkGuardian CLMIDIRoundTripTester CLYamahaConsoleSimulator CLMIDINetworkDashboard CLAudioConfigurationChecker CLYamahaSimulatorDashboard; do
