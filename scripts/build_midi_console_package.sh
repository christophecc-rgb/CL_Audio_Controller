...
for tool in CLMIDINetworkGuardian CLMIDIRoundTripTester CLYamahaConsoleSimulator CLMIDINetworkDashboard CLAudioConfigurationChecker; do
  ditto "$WORK_DIR/native-tools/$tool" "$KIT_ROOT/Network Tools/$tool"
  ditto "$WORK_DIR/native-tools/$tool" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/Network Tools/$tool"
done
ditto "$TOOLS_SOURCE/reconnect_legacy_rtp.applescript" "$KIT_ROOT/Network Tools/reconnect_legacy_rtp.applescript"
ditto "$TOOLS_SOURCE/reconnect_legacy_rtp.applescript" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/Network Tools/reconnect_legacy_rtp.applescript"
ditto "$TOOLS_SOURCE/connect_rtp_peer.applescript" "$KIT_ROOT/Network Tools/connect_rtp_peer.applescript"
ditto "$TOOLS_SOURCE/connect_rtp_peer.applescript" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/Network Tools/connect_rtp_peer.applescript"
ditto "$TOOLS_SOURCE/list_rtp_peers.applescript" "$KIT_ROOT/Network Tools/list_rtp_peers.applescript"
ditto "$TOOLS_SOURCE/list_rtp_peers.applescript" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/Network Tools/list_rtp_peers.applescript"
ditto "$TOOLS_SOURCE/open_rtp_settings.applescript" "$KIT_ROOT/Network Tools/open_rtp_settings.applescript"
ditto "$TOOLS_SOURCE/open_rtp_settings.applescript" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/Network Tools/open_rtp_settings.applescript"
ditto "$TOOLS_SOURCE/README.md" "$KIT_ROOT/Documentation/OUTILS_RESEAU.md"

ditto "$WORK_DIR/native-tools/CLMIDINetworkDashboard" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/MacOS/CL MIDI Network Assistant"
ditto "$PROJECT_ROOT/packaging/CL_MIDI_Network_Assistant.sh" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/LegacyAssistant.sh"
...
ditto "$DEVICE_SOURCE/paradis_latin_logo.jpg" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/paradis_latin_logo.jpg"
chmod +x "$KIT_ROOT/CL MIDI Network Manager.app/Contents/MacOS/CL MIDI Network Assistant" "$KIT_ROOT/CL MIDI Network Manager.app/Contents/Resources/LegacyAssistant.sh" "$KIT_ROOT/Network Tools"/CLMIDI*
...
L'application CL MIDI Network Manager fournit le test aller-retour, le simulateur
