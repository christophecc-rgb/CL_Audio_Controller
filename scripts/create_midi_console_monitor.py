...
def device_payload():
    boxes = [
        ...
        box("lookup-cl5", "newobj", [35.0, 525.0, 220.0, 22.0], text="js CLMidiConsoleDisplay.js CL5 1", numoutlets=2),
        box("lookup-ql1-cc", "newobj", [200.0, 525.0, 235.0, 22.0], text="js CLMidiConsoleDisplay.js QL1_CC 1", numoutlets=2),
        box("lookup-ql1-pgm", "newobj", [365.0, 525.0, 245.0, 22.0], text="js CLMidiConsoleDisplay.js QL1_PGM 1", numoutlets=2),
        ...
        box("outgoing-cl5-osc", "newobj", [35.0, 810.0, 235.0, 22.0],
            text="oscformat cl midi-monitor outgoing cl5"),
        box("outgoing-ql1-osc", "newobj", [280.0, 810.0, 235.0, 22.0],
            text="oscformat cl midi-monitor outgoing ql1"),
        box("outgoing-udp", "newobj", [525.0, 810.0, 70.0, 22.0],
            text="udpsend", numoutlets=0),
        box("destination-host", "textedit", [120.0, 132.0, 235.0, 22.0],
            presentation=1, presentation_rect=[120.0, 128.0, 235.0, 22.0],
            varname="osc_destination_host", text="127.0.0.1", rounded=5),
        box("destination-host-label", "comment", [14.0, 134.0, 102.0, 18.0],
            numoutlets=0, presentation=1, presentation_rect=[14.0, 130.0, 102.0, 18.0],
            text="SERVEUR OSC", fontsize=8.0, textcolor=[0.58, 0.64, 0.72, 1.0]),
        box("destination-host-route", "newobj", [605.0, 810.0, 62.0, 22.0], text="route text"),
        box("destination-host-message", "newobj", [675.0, 810.0, 82.0, 22.0], text="prepend host"),
        box("destination-host-pattr", "newobj", [605.0, 845.0, 390.0, 22.0],
            text="pattr osc_destination_host_state @bindto osc_destination_host @initial 127.0.0.1 @type symbol @parameter_enable 1"),
        box("destination-port", "live.numbox", [420.0, 132.0, 70.0, 22.0],
            presentation=1, presentation_rect=[420.0, 128.0, 70.0, 22.0],
            varname="osc_destination_port", parameter_enable=1,
            parameter_mmin=1.0, parameter_mmax=65535.0, parameter_initial=[11001.0],
            parameter_initial_enable=1),
        box("destination-port-label", "comment", [365.0, 134.0, 50.0, 18.0],
            numoutlets=0, presentation=1, presentation_rect=[365.0, 130.0, 50.0, 18.0],
            text="PORT", fontsize=8.0, textcolor=[0.58, 0.64, 0.72, 1.0]),
        box("destination-port-message", "newobj", [765.0, 810.0, 78.0, 22.0], text="prepend port"),
        box("destination-port-pattr", "newobj", [605.0, 880.0, 350.0, 22.0],
        ...
        box("send-cl5-program", "newobj", [80.0, 575.0, 180.0, 22.0], text="s CL_MIDI_MON_CL5_PROGRAM", numoutlets=0),
        box("send-ql1-cc-program", "newobj", [270.0, 575.0, 180.0, 22.0], text="s CL_MIDI_MON_QL1_PROGRAM", numoutlets=0),
        box("send-ql1-pgm-program", "newobj", [460.0, 575.0, 180.0, 22.0], text="s CL_MIDI_MON_QL1_PROGRAM", numoutlets=0),
        ...
        box("recv-cl5-program", "newobj", [350.0, 605.0, 180.0, 22.0], text="r CL_MIDI_MON_CL5_PROGRAM"),
        box("recv-ql1-program", "newobj", [540.0, 605.0, 180.0, 22.0], text="r CL_MIDI_MON_QL1_PROGRAM"),
        box("set-cl5-program", "newobj", [350.0, 630.0, 72.0, 22.0], text="prepend set"),
        box("set-ql1-program", "newobj", [540.0, 630.0, 72.0, 22.0], text="prepend set"),
        box("route-empty-cl5", "newobj", [35.0, 630.0, 135.0, 22.0], text="route __CL_EMPTY__"),
        box("route-empty-ql1", "newobj", [195.0, 630.0, 135.0, 22.0], text="route __CL_EMPTY__"),
        box("empty-cl5", "message", [35.0, 655.0, 38.0, 22.0], text="set"),
        box("empty-ql1", "message", [195.0, 655.0, 38.0, 22.0], text="set"),
        box("set-cl5", "newobj", [35.0, 640.0, 72.0, 22.0], text="prepend set"),
        box("set-ql1", "newobj", [195.0, 640.0, 72.0, 22.0], text="prepend set"),
        box("floating-message", "message", [610.0, 440.0, 500.0, 22.0], text="window flags float nogrow close nozoom, window size 180 120 720 270, window exec, presentation 1, locked 1, front"),
        box("thispatcher", "newobj", [610.0, 475.0, 76.0, 22.0], text="thispatcher", numoutlets=2, save=["#N", "thispatcher", ";", "#Q", "end", ";"]),
        box("auto-window-select", "newobj", [700.0, 475.0, 36.0, 22.0], text="sel 1"),
        box("auto-window-delay", "newobj", [745.0, 475.0, 58.0, 22.0], text="delay 800"),
        box(
        ...
        box("display-cl5", "message", [95.0, 43.0, 245.0, 22.0], presentation=1, presentation_rect=[95.0, 42.0, 245.0, 22.0], text="—", fontsize=11.0, fontface=1, textcolor=[0.35, 0.72, 1.0, 1.0], bgcolor=[0.03, 0.06, 0.09, 1.0], border=0, rounded=5),
        box("display-ql1", "message", [95.0, 76.0, 245.0, 22.0], presentation=1, presentation_rect=[95.0, 75.0, 245.0, 22.0], text="—", fontsize=11.0, fontface=1, textcolor=[0.60, 0.82, 1.0, 1.0], bgcolor=[0.04, 0.07, 0.10, 1.0], border=0, rounded=5),
        box("program-cl5", "message", [345.0, 43.0, 38.0, 22.0], presentation=1, presentation_rect=[345.0, 42.0, 38.0, 22.0], text="—", fontsize=10.0, fontface=1, textcolor=[0.95, 0.78, 0.38, 1.0], bgcolor=[0.06, 0.07, 0.09, 1.0], border=0, rounded=5),
        box("program-ql1", "message", [345.0, 76.0, 38.0, 22.0], presentation=1, presentation_rect=[345.0, 75.0, 38.0, 22.0], text="—", fontsize=10.0, fontface=1, textcolor=[0.95, 0.78, 0.38, 1.0], bgcolor=[0.06, 0.07, 0.09, 1.0], border=0, rounded=5),
        ...
        box("midi-status", "message", [14.0, 106.0, 286.0, 22.0], presentation=1, presentation_rect=[14.0, 104.0, 286.0, 20.0], text="MIDI · en attente", fontsize=9.0, textcolor=[0.95, 0.72, 0.32, 1.0], bgcolor=[0.04, 0.05, 0.07, 1.0], border=0),
        box("floating-button", "textbutton", [310.0, 106.0, 75.0, 22.0], numoutlets=1, presentation=1, presentation_rect=[310.0, 104.0, 75.0, 20.0], text="DÉTACHER", fontsize=8.0, bgcolor=[0.16, 0.26, 0.38, 1.0]),
        box(
            "auto-window", "live.toggle", [395.0, 106.0, 20.0, 20.0],
            presentation=1, presentation_rect=[395.0, 104.0, 20.0, 20.0],
            parameter_enable=1, varname="auto_open_monitor",
            saved_attribute_attributes={"valueof": {
        ...
        box("auto-window-label", "comment", [417.0, 106.0, 43.0, 18.0], numoutlets=0, presentation=1, presentation_rect=[417.0, 105.0, 43.0, 18.0], text="AUTO", fontsize=8.0, textcolor=[0.58, 0.64, 0.72, 1.0]),
        box("clear-button", "textbutton", [465.0, 106.0, 62.0, 22.0], numoutlets=1, presentation=1, presentation_rect=[465.0, 104.0, 62.0, 20.0], text="EFFACER", fontsize=8.0),
    ...
    lines = [
        ...
        line("lookup-cl5", "send-cl5-program", outlet=1),
        line("event-gate", "request-cl5", outlet=0),
        line("event-gate", "outgoing-cl5-osc", outlet=0),
        line("outgoing-cl5-osc", "outgoing-udp"),
        ...
        line("lookup-ql1-cc", "send-ql1-cc-program", outlet=1),
        line("event-gate", "request-ql1-cc", outlet=1),
        line("event-gate", "outgoing-ql1-osc", outlet=1),
        ...
        line("lookup-ql1-pgm", "send-ql1-pgm-program", outlet=1),
        line("event-gate", "request-ql1-pgm", outlet=2),
        line("event-gate", "outgoing-ql1-osc", outlet=2),
        line("outgoing-ql1-osc", "outgoing-udp"),
        line("destination-host", "destination-host-route"),
        line("destination-host-route", "destination-host-message"),
        line("destination-host-message", "outgoing-udp"),
        line("destination-host-pattr", "destination-host-message"),
        line("destination-port", "destination-port-message"),
        line("destination-port-message", "outgoing-udp"),
        line("destination-port-pattr", "destination-port-message"),
        line("role-defer", "destination-host-pattr"),
        line("role-defer", "destination-port-pattr"),
        ...
        line("recv-cl5", "route-empty-cl5"),
        line("route-empty-cl5", "empty-cl5", outlet=0),
        line("empty-cl5", "display-cl5"),
        line("route-empty-cl5", "set-cl5", outlet=1),
        line("set-cl5", "display-cl5"),
        line("recv-ql1", "route-empty-ql1"),
        line("route-empty-ql1", "empty-ql1", outlet=0),
        line("empty-ql1", "display-ql1"),
        line("route-empty-ql1", "set-ql1", outlet=1),
        line("set-ql1", "display-ql1"),
        line("recv-cl5-program", "set-cl5-program"),
        line("set-cl5-program", "program-cl5"),
        line("recv-ql1-program", "set-ql1-program"),
        line("set-ql1-program", "program-ql1"),
        line("clear-button", "clear-message"),
        line("clear-message", "display-cl5", order=0),
        line("clear-message", "display-ql1", order=1),
        line("clear-message", "program-cl5", order=2),
        line("clear-message", "program-ql1", order=3),
        line("floating-button", "floating-message"),
        line("auto-window", "auto-window-select"),
        line("auto-window-select", "auto-window-delay"),
        line("auto-window-delay", "floating-message"),
        line("floating-message", "thispatcher"),
